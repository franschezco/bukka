     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand">My<span>B</span>ukka.</a>
               </div>
...
<a href="#" class="section-btn" style="height: 4em;width:12em;padding: top -4em;padding:bottom 4em; align-content:center;font-weight:900;padding-left:2em;text-align:center;justify-content:center">CART <span class="fa-stack fa-2x " data-count="{{$count}}">
